...
def main() -> None:
    ...
    # e_shoff
    contents[0x0028] = 0xc0
    contents[0x0029] = 0x00
    ...
    # mov al, byte ptr [rdi]
    contents[0x0040] = 0x8a
    contents[0x0041] = 0x07

    # cmp al, 0x00
    contents[0x0042] = 0x3c
    contents[0x0043] = 0x00

    # je .Lreturn
    contents[0x0044] = 0x74
    contents[0x0045] = 0x19

    # cmp al, 0x41
    contents[0x0046] = 0x3c
    contents[0x0047] = 0x41

    # jb .Lskip
    contents[0x0048] = 0x72
    contents[0x0049] = 0x10

    # cmp al, 0x5a
    contents[0x004a] = 0x3c
    contents[0x004b] = 0x5a

    # jbe .Lswap
    contents[0x004c] = 0x76
    contents[0x004d] = 0x08

    # cmp al, 0x61
    contents[0x004e] = 0x3c
    contents[0x004f] = 0x61

    # jb .Lskip
    contents[0x0050] = 0x72
    contents[0x0051] = 0x08

    # cmp al, 0x7a
    contents[0x0052] = 0x3c
    contents[0x0053] = 0x7a

    # ja .Lskip
    contents[0x0054] = 0x77
    contents[0x0055] = 0x04

    # .Lswap:

    # xor al, 0x20
    contents[0x0056] = 0x34
    contents[0x0057] = 0x20

    # mov byte ptr [rdi], al
    contents[0x0058] = 0x88
    contents[0x0059] = 0x07

    # .Lskip:

    # inc rdi
    contents[0x005a] = 0x48
    contents[0x005b] = 0xff
    contents[0x005c] = 0xc7

    # jmp .Lloop
    contents[0x005d] = 0xeb
    contents[0x005e] = 0xe1

    # .Lreturn:

    # ret
    contents[0x005f] = 0xc3
    ...
    # "swapcase\0"
    contents[0x0091] = 0x73
    contents[0x0092] = 0x77
    contents[0x0093] = 0x61
    contents[0x0094] = 0x70
    contents[0x0095] = 0x63
    contents[0x0096] = 0x61
    contents[0x0097] = 0x73
    contents[0x0098] = 0x65
    ...
    # ".text\0"
    contents[0x009b] = 0x2e
    contents[0x009c] = 0x74
    contents[0x009d] = 0x65
    contents[0x009e] = 0x78
    contents[0x009f] = 0x74
    contents[0x00a0] = 0x00

    # ".symtab\0"
    contents[0x00a1] = 0x2e
    contents[0x00a2] = 0x73
    contents[0x00a3] = 0x79
    contents[0x00a4] = 0x6d
    contents[0x00a5] = 0x74
    contents[0x00a6] = 0x61
    contents[0x00a7] = 0x62
    contents[0x00a8] = 0x00

    # ".strtab\0"
    contents[0x00a9] = 0x2e
    contents[0x00aa] = 0x73
    contents[0x00ab] = 0x74
    contents[0x00ac] = 0x72
    contents[0x00ad] = 0x74
    contents[0x00ae] = 0x61
    contents[0x00af] = 0x62
    contents[0x00b0] = 0x00

    # ".shstrtab\0"
    contents[0x00b1] = 0x2e
    contents[0x00b2] = 0x73
    contents[0x00b3] = 0x68
    contents[0x00b4] = 0x73
    contents[0x00b5] = 0x74
    contents[0x00b6] = 0x72
    contents[0x00b7] = 0x74
    contents[0x00b8] = 0x61
    contents[0x00b9] = 0x62
    ...
    contents[0x0111] = 0x00
    contents[0x0112] = 0x00
    contents[0x0113] = 0x00
    contents[0x0114] = 0x00
    contents[0x0115] = 0x00
    contents[0x0116] = 0x00
    contents[0x0117] = 0x00

    # sh_offset
    contents[0x0118] = 0x40
    ...
    # sh_size
    contents[0x0120] = 0x20
    contents[0x0121] = 0x00
    contents[0x0122] = 0x00
    contents[0x0123] = 0x00
    contents[0x0124] = 0x00
    contents[0x0125] = 0x00
    contents[0x0126] = 0x00
    contents[0x0127] = 0x00

    # sh_link
    contents[0x0128] = 0x00
    contents[0x0129] = 0x00
    contents[0x012a] = 0x00
    contents[0x012b] = 0x00

    # sh_info
    contents[0x012c] = 0x00
    contents[0x012d] = 0x00
    contents[0x012e] = 0x00
    contents[0x012f] = 0x00

    # sh_addralign
    contents[0x0130] = 0x01
    ...
    contents[0x0147] = 0x00

    # sh_flags
    contents[0x0148] = 0x00
    ...
    # sh_addr
    contents[0x0150] = 0x00
    contents[0x0151] = 0x00
    contents[0x0152] = 0x00
    contents[0x0153] = 0x00
    contents[0x0154] = 0x00
    contents[0x0155] = 0x00
    contents[0x0156] = 0x00
    contents[0x0157] = 0x00

    # sh_offset
    contents[0x0158] = 0x60
    contents[0x0159] = 0x00
    contents[0x015a] = 0x00
    contents[0x015b] = 0x00
    contents[0x015c] = 0x00
    contents[0x015d] = 0x00
    contents[0x015e] = 0x00
    contents[0x015f] = 0x00

    # sh_size
    contents[0x0160] = 0x30
    ...
    with open("bin/rel-swapcase.o", "wb") as file:
        file.write(contents)
