...
# lea rbx, [rip + string]
contents[0x0040] = 0x48
contents[0x0041] = 0x8d
contents[0x0042] = 0x1d
...
# mov rdi, rbx
contents[0x0047] = 0x48
contents[0x0048] = 0x89
contents[0x0049] = 0xdf

# call println
contents[0x004a] = 0xe8
...
# mov rdi, rbx
contents[0x004f] = 0x48
contents[0x0050] = 0x89
contents[0x0051] = 0xdf

# call swapcase
contents[0x0052] = 0xe8
...
# mov rdi, rbx
contents[0x0057] = 0x48
contents[0x0058] = 0x89
contents[0x0059] = 0xdf

# call println
contents[0x005a] = 0xe8
...
# mov eax, 0x3c
contents[0x005f] = 0xb8
contents[0x0060] = 0x3c
contents[0x0061] = 0x00
contents[0x0062] = 0x00
contents[0x0063] = 0x00

# mov edi, 0x00
contents[0x0064] = 0xbf
...
# syscall
contents[0x0069] = 0x0f
contents[0x006a] = 0x05

# >>>>>>>> DATA <<<<<<<<

# string:

# "1!lower gOeS UPPER!1\0"
contents[0x006b] = 0x31
contents[0x006c] = 0x21
contents[0x006d] = 0x6c
contents[0x006e] = 0x6f
contents[0x006f] = 0x77
contents[0x0070] = 0x65
contents[0x0071] = 0x72
contents[0x0072] = 0x20
contents[0x0073] = 0x67
contents[0x0074] = 0x4f
contents[0x0075] = 0x65
contents[0x0076] = 0x53
contents[0x0077] = 0x20
contents[0x0078] = 0x55
contents[0x0079] = 0x50
contents[0x007a] = 0x50
contents[0x007b] = 0x45
contents[0x007c] = 0x52
contents[0x007d] = 0x21
contents[0x007e] = 0x31
...
contents[0x009c] = 0x03

# st_other = STV_DEFAULT
contents[0x009d] = 0x00

# st_shndx = .data
contents[0x009e] = 0x03
...
contents[0x00b4] = 0x01

# st_other = STV_DEFAULT
contents[0x00b5] = 0x00

# st_shndx = .data
contents[0x00b6] = 0x03
...
contents[0x010b] = 0x00
contents[0x010c] = 0x00
contents[0x010d] = 0x00
contents[0x010e] = 0x00
contents[0x010f] = 0x00
...
contents[0x0114] = 0x69
contents[0x0115] = 0x6e
contents[0x0116] = 0x67
contents[0x0117] = 0x00

# "_start\0"
contents[0x0118] = 0x5f
contents[0x0119] = 0x73
contents[0x011a] = 0x74
contents[0x011b] = 0x61
contents[0x011c] = 0x72
contents[0x011d] = 0x74
contents[0x011e] = 0x00

# "println\0"
contents[0x011f] = 0x70
contents[0x0120] = 0x72
contents[0x0121] = 0x69
contents[0x0122] = 0x6e
contents[0x0123] = 0x74
contents[0x0124] = 0x6c
contents[0x0125] = 0x6e
contents[0x0126] = 0x00

# "swapcase\0"
contents[0x0127] = 0x73
contents[0x0128] = 0x77
contents[0x0129] = 0x61
contents[0x012a] = 0x70
contents[0x012b] = 0x63
contents[0x012c] = 0x61
contents[0x012d] = 0x73
contents[0x012e] = 0x65
contents[0x012f] = 0x00
...
# r_offset
contents[0x0130] = 0x03
contents[0x0131] = 0x00
contents[0x0132] = 0x00
contents[0x0133] = 0x00
contents[0x0134] = 0x00
contents[0x0135] = 0x00
contents[0x0136] = 0x00
contents[0x0137] = 0x00

# r_info = ELF64_R_INFO(.data, R_X86_64_PC32)
contents[0x0138] = 0x02
contents[0x0139] = 0x00
contents[0x013a] = 0x00
contents[0x013b] = 0x00
contents[0x013c] = 0x01
contents[0x013d] = 0x00
contents[0x013e] = 0x00
contents[0x013f] = 0x00

# r_addend
contents[0x0140] = 0xfc
contents[0x0141] = 0xff
contents[0x0142] = 0xff
contents[0x0143] = 0xff
contents[0x0144] = 0xff
contents[0x0145] = 0xff
contents[0x0146] = 0xff
contents[0x0147] = 0xff
...
# r_offset
contents[0x0148] = 0x0b
contents[0x0149] = 0x00
contents[0x014a] = 0x00
contents[0x014b] = 0x00
contents[0x014c] = 0x00
contents[0x014d] = 0x00
contents[0x014e] = 0x00
contents[0x014f] = 0x00

# r_info = ELF64_R_INFO(println, R_X86_64_PC32)
contents[0x0150] = 0x02
contents[0x0151] = 0x00
contents[0x0152] = 0x00
contents[0x0153] = 0x00
contents[0x0154] = 0x04
contents[0x0155] = 0x00
contents[0x0156] = 0x00
contents[0x0157] = 0x00

# r_addend
contents[0x0158] = 0xfc
contents[0x0159] = 0xff
contents[0x015a] = 0xff
contents[0x015b] = 0xff
contents[0x015c] = 0xff
contents[0x015d] = 0xff
contents[0x015e] = 0xff
contents[0x015f] = 0xff

# ========================

# 0x0013: swapcase - 0x04

# r_offset
contents[0x0160] = 0x13
contents[0x0161] = 0x00
contents[0x0162] = 0x00
contents[0x0163] = 0x00
contents[0x0164] = 0x00
contents[0x0165] = 0x00
contents[0x0166] = 0x00
contents[0x0167] = 0x00

# r_info = ELF64_R_INFO(swapcase, R_X86_64_PC32)
contents[0x0168] = 0x02
contents[0x0169] = 0x00
contents[0x016a] = 0x00
contents[0x016b] = 0x00
contents[0x016c] = 0x05
contents[0x016d] = 0x00
contents[0x016e] = 0x00
contents[0x016f] = 0x00

# r_addend
contents[0x0170] = 0xfc
contents[0x0171] = 0xff
contents[0x0172] = 0xff
contents[0x0173] = 0xff
contents[0x0174] = 0xff
contents[0x0175] = 0xff
contents[0x0176] = 0xff
contents[0x0177] = 0xff
...
# r_info = ELF64_R_INFO(println, R_X86_64_PC32)
contents[0x0180] = 0x02
contents[0x0181] = 0x00
contents[0x0182] = 0x00
contents[0x0183] = 0x00
contents[0x0184] = 0x04
contents[0x0185] = 0x00
contents[0x0186] = 0x00
contents[0x0187] = 0x00

# r_addend
contents[0x0188] = 0xfc
contents[0x0189] = 0xff
contents[0x018a] = 0xff
contents[0x018b] = 0xff
contents[0x018c] = 0xff
contents[0x018d] = 0xff
contents[0x018e] = 0xff
contents[0x018f] = 0xff
...
# ".text\0"
contents[0x0191] = 0x2e
contents[0x0192] = 0x74
contents[0x0193] = 0x65
contents[0x0194] = 0x78
contents[0x0195] = 0x74
contents[0x0196] = 0x00

# ".rela.text\0"
contents[0x0197] = 0x2e
contents[0x0198] = 0x72
contents[0x0199] = 0x65
contents[0x019a] = 0x6c
contents[0x019b] = 0x61
contents[0x019c] = 0x2e
contents[0x019d] = 0x74
contents[0x019e] = 0x65
contents[0x019f] = 0x78
contents[0x01a0] = 0x74
contents[0x01a1] = 0x00

# ".data\0"
contents[0x01a2] = 0x2e
contents[0x01a3] = 0x64
contents[0x01a4] = 0x61
contents[0x01a5] = 0x74
contents[0x01a6] = 0x61
contents[0x01a7] = 0x00

# ".symtab\0"
contents[0x01a8] = 0x2e
contents[0x01a9] = 0x73
contents[0x01aa] = 0x79
contents[0x01ab] = 0x6d
contents[0x01ac] = 0x74
contents[0x01ad] = 0x61
contents[0x01ae] = 0x62
contents[0x01af] = 0x00

# ".strtab\0"
contents[0x01b0] = 0x2e
contents[0x01b1] = 0x73
contents[0x01b2] = 0x74
contents[0x01b3] = 0x72
contents[0x01b4] = 0x74
contents[0x01b5] = 0x61
contents[0x01b6] = 0x62
contents[0x01b7] = 0x00

# ".shstrtab\0"
contents[0x01b8] = 0x2e
contents[0x01b9] = 0x73
contents[0x01ba] = 0x68
contents[0x01bb] = 0x73
contents[0x01bc] = 0x74
contents[0x01bd] = 0x72
contents[0x01be] = 0x74
contents[0x01bf] = 0x61
contents[0x01c0] = 0x62
contents[0x01c1] = 0x00

# >>>>>>>>>> SECTION HEADER TABLE <<<<<<<<<<

# sh_name
contents[0x01c8] = 0x00
...
# sh_entsize
contents[0x0200] = 0x00
contents[0x0201] = 0x00
...
# sh_offset
contents[0x0260] = 0x30
contents[0x0261] = 0x01
...
# sh_entsize
contents[0x0300] = 0x18
contents[0x0301] = 0x00
...
# sh_offset
contents[0x0320] = 0x10
contents[0x0321] = 0x01
...
# sh_size
contents[0x0328] = 0x20
contents[0x0329] = 0x00
contents[0x032a] = 0x00
contents[0x032b] = 0x00
contents[0x032c] = 0x00
contents[0x032d] = 0x00
contents[0x032e] = 0x00
contents[0x032f] = 0x00

# sh_link
contents[0x0330] = 0x00
contents[0x0331] = 0x00
contents[0x0332] = 0x00
contents[0x0333] = 0x00

# sh_info
contents[0x0334] = 0x00
contents[0x0335] = 0x00
contents[0x0336] = 0x00
contents[0x0337] = 0x00

# sh_addralign
contents[0x0338] = 0x01
contents[0x0339] = 0x00
contents[0x033a] = 0x00
contents[0x033b] = 0x00
contents[0x033c] = 0x00
contents[0x033d] = 0x00
contents[0x033e] = 0x00
contents[0x033f] = 0x00

# sh_entsize
contents[0x0340] = 0x00
contents[0x0341] = 0x00
contents[0x0342] = 0x00
contents[0x0343] = 0x00
contents[0x0344] = 0x00
contents[0x0345] = 0x00
contents[0x0346] = 0x00
contents[0x0347] = 0x00

# ========================

# sh_name = .shstrtab
contents[0x0348] = 0x28
contents[0x0349] = 0x00
contents[0x034a] = 0x00
contents[0x034b] = 0x00

# sh_type = SHT_STRTAB
contents[0x034c] = 0x03
contents[0x034d] = 0x00
contents[0x034e] = 0x00
contents[0x034f] = 0x00

# sh_flags
contents[0x0350] = 0x00
contents[0x0351] = 0x00
contents[0x0352] = 0x00
contents[0x0353] = 0x00
contents[0x0354] = 0x00
contents[0x0355] = 0x00
contents[0x0356] = 0x00
contents[0x0357] = 0x00

# sh_addr
contents[0x0358] = 0x00
contents[0x0359] = 0x00
contents[0x035a] = 0x00
contents[0x035b] = 0x00
contents[0x035c] = 0x00
contents[0x035d] = 0x00
contents[0x035e] = 0x00
contents[0x035f] = 0x00

# sh_offset
contents[0x0360] = 0x90
contents[0x0361] = 0x01
contents[0x0362] = 0x00
contents[0x0363] = 0x00
contents[0x0364] = 0x00
contents[0x0365] = 0x00
contents[0x0366] = 0x00
contents[0x0367] = 0x00

# sh_size
contents[0x0368] = 0x32
contents[0x0369] = 0x00
contents[0x036a] = 0x00
contents[0x036b] = 0x00
contents[0x036c] = 0x00
contents[0x036d] = 0x00
contents[0x036e] = 0x00
contents[0x036f] = 0x00

# sh_link
contents[0x0370] = 0x00
contents[0x0371] = 0x00
contents[0x0372] = 0x00
contents[0x0373] = 0x00

# sh_info
contents[0x0374] = 0x00
contents[0x0375] = 0x00
contents[0x0376] = 0x00
contents[0x0377] = 0x00

# sh_addralign
contents[0x0378] = 0x01
contents[0x0379] = 0x00
contents[0x037a] = 0x00
contents[0x037b] = 0x00
contents[0x037c] = 0x00
contents[0x037d] = 0x00
contents[0x037e] = 0x00
contents[0x037f] = 0x00

# sh_entsize
contents[0x0380] = 0x00
contents[0x0381] = 0x00
contents[0x0382] = 0x00
contents[0x0383] = 0x00
contents[0x0384] = 0x00
contents[0x0385] = 0x00
contents[0x0386] = 0x00
contents[0x0387] = 0x00

with open("bin/rel-swap-n-print.o", "wb") as file:
    file.write(contents)
